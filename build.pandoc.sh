...
pandoc 00_frontmatter.md 01_abstract.md 02_problemdescription.md 02a_state_of_the_art.md --pdf-engine=xelatex --template ./templates/eisvogel-book.latex --number-sections --listings --toc -o export.pdf