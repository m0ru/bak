...
When you start reading about React you'll probably stumple across Flux (see fig. \ref{fig:flux}) rather earlier than later. It is the architecture popularized alongside of React and akin to MVC in that it seperates handling input, updating the state and displaying the latter.
...
\caption[Flux-architecture]{Flux-architecture via \url{https://facebook.github.io/react/img/blog/flux-diagram.png}}
\label{fig:flux}
\end{figure*}
