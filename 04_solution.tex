...
% CHAPTER-OUTLINE:
% one section on tool-choices
% one section on the current architecture (how we planned it vs how it turned out, e.g. actors directly accessing state)
% one on future work: drop actors, drop angular / look at ng2
