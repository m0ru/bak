...
\usepackage{menukeys}  % symbols that look like key-presses (e.g. the `enter`-key to signal line-breaks)
...
\newcommand{\authorname}{Renée Singer} % The author name without titles.
...
\input{02_problemdescription.tex}
\input{02a_state_of_the_art.tex}
\input{03_methods.tex}
\input{04_solution.tex}
\input{05_guidelines.tex}
